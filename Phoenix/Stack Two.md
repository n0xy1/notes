...
Setting environment variables is pretty darn easy, just set `Variable=Value` prior to running your program.

This one builds again on the previous stacks. Except this time they want a specific environment variable, not a program argument.
